...
if __name__ == "__main__":
    compute_ndvi(
        red_path="data/raw/1scene_RED.tif",
        nir_path="data/raw/1scene_NIR.tif",
        output_path="data/processed/new_ndvi_teste.tif",
        preview_path="data/processed/new_ndvi_teste.png"
    )
